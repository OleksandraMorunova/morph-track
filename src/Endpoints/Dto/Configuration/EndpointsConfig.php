...
class EndpointsConfig
{
    ...
    {
        $this->postFiltering = (array) config('morph_track_config.route_pipelines.post_filtered', []);
        ...
        $this->prettyPrintTypes = (array) config('morph_track_config.pretty_print.types', []);
